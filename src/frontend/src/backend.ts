...
export class Backend implements backendInterface {
    ...
    async addProductToList(arg0: Id, arg1: bigint): Promise<Id> {
        if (this.processError) {
            try {
                const result = await this.actor.addProductToList(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createShoppingList(arg0: string, arg1: UserId, arg2: Array<Tag>): Promise<Id> {
        if (this.processError) {
            try {
                const result = await this.actor.createShoppingList(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
